...
{
  /// Walking & Sit
  class GZ_PLUGIN_VISIBLE ActorPlugin_Walking_Sit : public ModelPlugin
  {
    /// \brief Constructor
    public: ActorPlugin_Walking_Sit();
    ...
    /// \brief Count call void ActorPlugin_Walking_Sit::ChooseNewTarget()
    private: int CountCall = 0;

    /// \brief Time to Sit & Down
    private: double cycleTime_Sitting_Walk = 0.0;

    /// \brief Sitting Time
    private: double SittingTime = 10.0;
...
{
  /// Walking
  class GZ_PLUGIN_VISIBLE ActorPlugin_Walking : public ModelPlugin
  {
    /// \brief Constructor
    public: ActorPlugin_Walking();
...
{
  /// Running
  class GZ_PLUGIN_VISIBLE ActorPlugin_Running : public ModelPlugin
  {
    /// \brief Constructor
    public: ActorPlugin_Running();
